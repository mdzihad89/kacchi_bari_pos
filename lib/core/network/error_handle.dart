...
class ResponseCode {
  ...
  static const int unauthorised = 401; // failure, employee is not authorised
...
class ResponseMessage {
  ...
  static const String unauthorised = AppStrings.strUnauthorizedError; // failure, employee is not authorised
